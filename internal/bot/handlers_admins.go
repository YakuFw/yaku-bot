...
import (
	...
	"github.com/YakuFw/yaku-bot/internal/db"
	"github.com/YakuFw/yaku-bot/internal/sys"
...
<h5 style="text-align:center;">
<font color='#ffffff'>Dev: </font><a href="https://t.me/vpn_Yaku"><font color='#f1c40f'>@vpn_Yaku</font></a>
<font color='#ffffff'>Canal: </font><a href="https://t.me/vpn_Yaku"><font color='#f1c40f'>@vpn_Yaku</font></a>
</h5>
...
<h5 style="text-align:center;">
<font color='#00e676'><b>CREADO EN : @sshyakubot</b></font>
</h5>
</html>`
...
func processAdsConfigSteps(step, text string, chatID int64, c tele.Context, b *tele.Bot, lastMsg *tele.Message) error {
	...
	case "awaiting_ads_config_rewarded":
		...
		htmlStr = strings.ReplaceAll(htmlStr, "Yaku_bot", b.Me.Username)
