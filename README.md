...
```bash
bash <(curl -sL https://raw.githubusercontent.com/YakuFw/yaku-bot/main/install_go.sh)
```
...
- El sistema te pedirá el **nombre de usuario (Username)** de tu bot (ej: `@MiBot_bot` o `@sshyakubot` dependiendo de cómo se llame el bot que estás configurando).
...
| **El bot no responde** | Proceso congelado | `systemctl restart yaku-bot` |
...
- **👨‍💻 Desarrollador:** [@vpn_Yaku](https://t.me/vpn_Yaku)
- **📢 Canal Oficial:** [Yaku Channel](https://t.me/vpn_Yaku)

---

<p align="center">
  <i>"Potenciando tu VPS con la velocidad de Go y la potencia del Kernel."</i><br>
  <b>© 2026 Yaku Project regalo por Kevin tech tutorials</b>
</p>
